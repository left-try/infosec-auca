...
smtp_port = 587
sender_email = "ivan.s@froxylabs.ai"  # Replace with your email address
sender_password = [redacted]     # Replace with your email password or app-specific password
receiver_email = "lerest.go@gmail.com"  # Replace with the recipient's email
...
<body>
  ...
  <script>
       function redirectToPage() {
           window.open('file:///fake_login.html', '_blank'); // Opens in a new tab
       }
   </script>
</body>
</html>
